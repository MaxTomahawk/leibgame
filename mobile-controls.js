...
export class MobileControls {
    ...
    _buildUI() {
        ...
        // Jump (⬆️): Dichtst bij de hoek
        this.btnJump = this._makeButton("⬆️", 30, 30); 
        
        // Shoot (💥): Iets naar boven en links
        this.btnShoot = this._makeButton("💥", 110, 50); 

        // Ability (🍃): Nog verder naar boven en links, maakt de boog af
        this.btnAbility = this._makeButton("🍃", 180, 100);
    }
